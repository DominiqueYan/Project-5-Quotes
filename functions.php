...
function qod_scripts() {
    ...
    wp_enqueue_script( 'quotes-scripts', get_template_directory_uri() . '/build/js/scripts.min.js', array( 'jquery' ), false, true );
  wp_localize_script( 'quotes-scripts', 'qod_vars', array(
